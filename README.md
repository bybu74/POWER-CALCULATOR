POWER-CALCULATOR  este un soft  care calculeaza in functie de export energie electrica sau procentul de incarcare. softul este instalat pe un ESP32 si ruleaza impreuna cu HOME ASSISTANT
